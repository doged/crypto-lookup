...
function contextClickHandler(info, tab) {
	...
	chrome.storage.sync.get({
    	...
    	/*var lookupConfig = {
			...
			"DOGEDTX": "http://darkchain.link/tx/",
        ...
        var lookupConfig = {
        	...
        	"DOGEDAddress": ["http://darkchain.link/address/", "http://blockexperts.com/doged/address/"][items.dogedExplorer-1],
        	...
        	"DOGEDTX": ["http://darkchain.link/tx/", "http://blockexperts.com/doged/tx/"][items.dogedExplorer-1],
